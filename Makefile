...
$(BIN_DIR)/matrix_example: $(OBJ_DIR)/matrix_example.o $(OBJ_DIR)/filters.o bridge.touch
	$(CXX) $(CXXFLAGS) $(filter %.o, $^) -o $@ $(LDFLAGS)

$(BIN_DIR)/main: $(OBJ_DIR)/main.o $(OBJ_DIR)/filters.o $(OBJ_DIR)/improc.o $(OBJ_DIR)/canny.o $(OBJ_DIR)/alignment.o bridge.touch
	$(CXX) $(CXXFLAGS) $(filter %.o, $^) -o $@ $(LDFLAGS)
